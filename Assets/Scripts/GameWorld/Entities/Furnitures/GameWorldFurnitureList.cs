...
namespace TowerBuilder.GameWorld.Entities.Furnitures
{
    public class GameWorldFurnitureList : MonoBehaviour
    {
        ...
        */
        ...
        void Setup()
        {
            Registry.appState.Entities.Furnitures.events.onItemsAdded += OnFurnituresAdded;
            Registry.appState.Entities.Furnitures.events.onItemsRemoved += OnFurnituresRemoved;
